...
<body style="overflow:auto;overflow-x:hidden;margin:0 0;">
  ...
  <div class="carousel-inner">
    ...
    <div class="carousel-item">
      <img src="Resources/img/banner-04.jpg">
    </div>
  </div>
	...
	<div class="header">
		...
		<div class="nav" id="nav">
			<ul class="nav-main" id="nav-main">
				...
				<li id="cpfayyhygl" class="cpfayyhygl"><!-- <a	href="#product"> -->
	...
	<div id="homepage" class="homepage">
		...
		<div class="product" id="product">
			...
			<div class="productshow">
			   <div class="row">
            <div class="col-sm-3 marbot10" ontouchstart="this.classList.toggle(&#39;hover&#39;);">
                <a href="javascript:ContentJump('product_industry.do','kyhdyjfx');">
