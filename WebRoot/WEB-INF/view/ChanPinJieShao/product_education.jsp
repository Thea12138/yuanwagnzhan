			...
			<div class=contentshow>
				...
				<div class=rightcontent>
					<div class=contentnav>
						<span class="nav_title">智慧教育</span>
						<p>
					...
					<div class="contents">
						...
						<div class="clear"></div>				
						<p>智慧教育研究所致力于开展教育领域智能技术研究与产业化工作，研究平行系统、大数据、物联网等技术与教育的深度融合，推动面向青少年儿童的人工智能科技创新教育，助力教育综合改革和课程改革落地实施。</p>
						...
						<p class="protitlt">中小学人工智能教育体系</p>
						<p style="margin-top:0px;">基于面向智能时代的iSTREAM（intelligence for Sciences, Technology,Robotics,Engineering,Arts,and Management）多学科融合理念和iCDIOS（innovation for Conceive，Design，Implement，Operate, and Service）面向创新实践的综合培养模式，研发iSTREAM人工智能教育体系。推进科教融合、产教融合等合作模式，发扬多方资源优势，携手打造科技创新教育新生态。以iSTREAM教育体系为指导，为幼儿园到大学K-16学段研发具有核心竞争力的智能科技创新教育体系整体解决方案，培养学生科学探索和实践能力，助力教育综合改革。</p>
						<div class="img">
							<img src="Resources/img/cpjs/image030.jpg" style="max-width:100%;" />
						</div>
						
						<p class="protitlt">教育装备、课程、实验室</p>
						<p style="margin-top:0px;">结合教育体系框架，研发和引进教育装备产品，以教育装备为载体，采用项目式学习方式设计和开发了人工智能系列课程，并为学校建设人工智能教育创新实验室，解决基础教育阶段人工智能教育难点。</p>
						<div class="img">
							<img src="Resources/img/cpjs/image032.jpg" style="max-width:100%;" />
						</div>
