...
<script type="text/javascript">
	...
	$(function() {
	if(sessionStorage.focusUrl_Name=="xwdt_zyry_frame.do" ){
		if(sessionStorage.pageno!=undefined && sessionStorage.pageno!='')	{
		    pageno=sessionStorage.pageno;
		}
		
	 }
	 sessionStorage.focusUrl_Name = "xwdt_zyry_frame.do";
						...
						<ul>
							...
							<li id="intelligentinduestries"><a
								href="javascript:ContentJump('xwdt_zncyqk.do');"><span
									class="glyphicon glyphicon-chevron-right"
									style="font-size:10px;"></span> 智能产业期刊</a></li>
						</ul>
					</div>
				</div>
