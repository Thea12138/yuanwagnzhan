...
<script type="text/javascript">
	...
	$(function() {
	if(sessionStorage.focusUrl_Name=="xwdt_hyqbjb_frame.do" ){
		if(sessionStorage.pageno!=undefined && sessionStorage.pageno!='')	{
		    pageno=sessionStorage.pageno;
		}
		
	 }
	    sessionStorage.focusUrl_Name = "xwdt_hyqbjb_frame.do";
						...
						function(data) {
							...
							if (data != null) {
								...
								for (var i = 0; i < list.length; i++) {
									ht = ht
											+ "<tr>"
											+ "<td style='width:690px;'><a href='javascript:ContentJumpPage(\"BriefingShow.do?BriefingID="
											+ list[i].BriefingID
											+ "\");'>"
				...
				<div class=rightcontent>
					<div class=contentnav>
						<a href="javascript:JumpToIndex();"><span
							...
							href="javascript:void(0);"><span style="color:#0066cc;">
								行业情报简报</span></a>
					</div>
