...
<body>
	...
	<div>
		<ul class="breadcrumb">
			...
			<li><a href="javascript:void(0);">院务新闻</a></li>
		</ul>
	</div>
		...
		<div class="box col-md-12">
			<div class="box-inner">
				<div class="box-header well">
					<h2>
						<i class="glyphicon glyphicon-forward"></i> 院务新闻
					</h2>
				</div>
				<div class="box-content row">
					<div class="col-lg-7 col-md-12">
						...
						<table class="table table-bordered table-hover table-condensed">
							<thead>
								<tr>
									<th style="width:110px;text-align:center;">发布日期</th>
									<th style="width:200px;text-align:center;">标题</th>
									<th style="width:130px;text-align:center;">内容页</th>
					...
					<div class="modal-body">
						<form id="editform" name="editform" method="post"
							...
							<input type="hidden" id="hiddenID" name="NewsID" /> <input
								...
								id="NewsCategory" name="NewsCategory" value="G" />
							<table class="table">
								<tr>
								...
								<tr>
									...
									<td><input id="NewsTitle" type="text" class="form-control"
										name="NewsTitle" maxlength="200" /></td>
								</tr>
								<tr>
									<td>内容页：</td>
