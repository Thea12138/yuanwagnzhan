...
<script type="text/javascript">
	...
	$(document).ready(function() {
	    ...
	    //附件设置
		$("#attachList").fileinput({
			'showPreview' : false,
			'showUpload' : false,
			'allowedFileExtensions' : [ 'doc', 'docx',  'pdf', 'xls', 'xlsx' ],
			'elErrorContainer' : '#errorattach'
		});
		$("#attachList").on('fileselect', function(event, numFiles, label) {
			parent.$("#editattach").hide();
		});
...
<body>
	...
	<div>
		<ul class="breadcrumb">
			...
			<li><a href="javascript:void(0);">通知通告</a></li>
		</ul>
	</div>
		...
		<div class="box col-md-12">
			<div class="box-inner">
				<div class="box-header well">
					<h2>
						<i class="glyphicon glyphicon-forward"></i> 通知通告
					</h2>
				</div>
					...
					<div class="modal-body">
						<form id="editform" name="editform" method="post"
							...
							<table class="table">
								...
								<tr>
									<td>附件：</td>
									<td><input id="editattch"
										style="display: none;border: none; width: 100%;"
										readonly="readonly" /><input id="attachList" type="file"
										name="attachList" multiple />
										<div id="errorattach" class="help-block"></div></td>
								</tr>
								<tr>
									<td>图片：</td>
									<td><input id="editpic"
