...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$("#picturesList").fileinput({
			...
			'elErrorContainer' : '#errorimg1'
		});
		$("#picturesList").on('fileselect', function(event, numFiles, label) {
			parent.$("#editpic").hide();
		});

		$("#ThumbPicture").fileinput({
			'showPreview' : false,
			'showUpload' : false,
			'allowedFileExtensions' : [ 'jpg', 'png', 'gif' ],
			'elErrorContainer' : '#errorimg2'
		});
		$("#ThumbPicture").on('fileselect', function(event, numFiles, label) {
			parent.$("#edithomepic").hide();
		});
	...
	function CheckUI() {
		...
		if (parent.$("#edithomepic").val().trim() == ""
				&& parent.$("#ThumbPicture").val().trim() == "") {
			alert("请上传首页图片。");
			parent.$("#ThumbPicture").focus();
			return false;
		}
			...
			$.ajax({
				...
				success : function(data) {
					if (data != null) {
						...
						$("#edithomepic").val(data.ThumbPicture);
						$("#edithomepic").show();
					}
				}
			});
...
<body>
	...
	<div>
		<ul class="breadcrumb">
			...
			<li><a href="javascript:void(0);">学术盛宴</a></li>
		</ul>
	</div>
		...
		<div class="box col-md-12">
			<div class="box-inner">
				<div class="box-header well">
					<h2>
						<i class="glyphicon glyphicon-forward"></i> 学术盛宴
					</h2>
				</div>
					...
					<div class="modal-body">
						<form id="editform" name="editform" method="post"
							...
							<input type="hidden" id="hiddenID" name="NewsID" /> <input
								...
								id="NewsCategory" name="NewsCategory" value="D" />
							<table class="table">
								<tr>
								...
								<tr>
									...
									<td><input id="editpic"
										...
										<div id="errorimg1" class="help-block"></div></td>
								</tr>
								<tr>
									<td>首页图：</td>
									<td><input id="edithomepic"
										style="display: none;border: none; width: 100%;"
										readonly="readonly" /><input id="ThumbPicture" type="file"
										name="ThumbPicture" />
										<div id="errorimg2" class="help-block"></div></td>
								</tr>
								<tr>
