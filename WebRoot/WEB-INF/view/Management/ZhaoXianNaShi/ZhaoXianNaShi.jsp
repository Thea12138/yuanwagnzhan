...
<script type="text/javascript">
	...
	$(function() {
		...
		$("#btnEdit").click(function() {
			...
			srchange("ZhaoXianNaShiEdit.do?id="+ids)
					...
					if (data != null) {
						...
						for (var i = 0; i < list.length; i++) {
							ht = ht
								...
								+ (list[i].recruit_name == null ? ""
										: list[i].recruit_name)
								+ "</td>"
								+ "<td style='text-align:center;'>"
								+ (list[i].recruit_unit == null ? ""
										: list[i].recruit_unit)
								+ "</td>"
								+ "<td style='text-align:center;'>"
								+ (list[i].recruit_person == null ? ""
										: list[i].recruit_person)
								+ "</td>"
	
								+ "<td style='text-align:center;'>"
								+ (list[i].recruit_responsibility == null ? ""
										: list[i].recruit_responsibility) 
								+ "</td>"
								
								+ "<td style='text-align:center;'>"
								+ (list[i].recruit_require == null ? ""
										: list[i].recruit_require) 
								+ "</td>"
		...
		<div class="box col-md-12">
			<div class="box-inner">
				<div class="box-header well">
					<h2>
						<i class="glyphicon glyphicon-forward"></i> 招贤纳士
					</h2>
				</div>
					...
					<div class="col-lg-7 col-md-12">
						...
						<div class="alert alert-info">
							<a class="btn btn-primary"
								href="javascript:srchange('ZhaoXianNaShiAdd.do');"> <i
						...
						<table class="table table-bordered table-hover table-condensed" style="word-wrap:break-word; word-break:break-all;">
							<thead>
								<tr>
									<th style="width:200px;text-align:center;">职位名称</th>
									<th style="width:200px;text-align:center;">职位部门</th>
									<th style="width:90px;text-align:center;">所需人数</th>
									<th style="width:90px;text-align:center;">岗位职责</th>
									<th style="width:90px;text-align:center;">任职要求</th>
