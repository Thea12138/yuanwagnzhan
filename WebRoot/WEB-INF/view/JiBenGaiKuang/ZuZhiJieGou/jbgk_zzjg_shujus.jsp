...
<script type="text/javascript">
	$(function() {
	sessionStorage.focusUrl_Name = "jbgk_zzjg_shujus.do";
								...
								<ul id="zzjgxiala" class="zzjgxiala">
									...
									<li><a
										...
										style="color:#0956ac;"><img
											src="Resources/css/img/thirdnav.png" />&nbsp;智慧数据研究所</a></li>
									<li><a
				...
				<div class=rightcontent>
					<div class=contentnav>
						...
						<span class="glyphicon glyphicon-chevron-right"
							...
							style="color:#0066cc;"> 智慧数据研究所</span></a>
					</div>

					<div class=contents>
						<div class="departmenttitle">智慧数据研究所</div>
						<p style="font-size:20px;font-weight:bold;">智慧数据研究所 <img src="Resources/css/contentimg/shujus3.jpg" width="50px" height="50px"  align="right"/></p>
						<br/>
						<p>智慧数据研究所及其孵化公司青岛传视智能科技有限公司专注于提升互联网视频收视体验，以“服务于互联网上的每一次视频播放”为自身使命，通过搭建的混合（公有＋私有）视频大数据云平台联盟为互联网视频行业客户的系统运维（视频收视体验）和业务运营（盈利能力）提供数据服务。</p>
						<p style="font-size:20px;font-weight:bold;">研发团队</p>
						<p>研究所执行所长张进宇,
							北京大学计算机科学博士；2007年中国－卡内基梅隆大学赫伯.西蒙访问学者；Conviva公司高级软件工程师，架构师。2016
							年起开始担任青岛智能产业技术研究院智慧数据研究所执行所长。团队现有成员10多人，其中科研人员6人。</p>
						...
						<p style="text-align:center;"><img src="Resources/css/contentimg/shujus1.png" width="600px" height="378px"  /></p>
						<p style="text-align:center;"><img src="Resources/css/contentimg/shujus2.jpg" width="600px" height="336px"  /></p>
