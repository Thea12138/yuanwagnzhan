...
<script type="text/javascript">
	$(function() {
	sessionStorage.focusUrl_Name = "jbgk_zzjg_nongyes.do";
								...
								<ul id="zzjgxiala" class="zzjgxiala">
									...
									<li id="jbgk_zzjg_nongyes"><a
										...
										style="color:#0956ac;"><img
											src="Resources/css/img/thirdnav.png" />&nbsp;智慧农业研究所</a></li>
				...
				<div class=rightcontent>
					<div class=contentnav>
						...
						<span class="glyphicon glyphicon-chevron-right"
							...
							style="color:#0066cc;"> 智慧农业研究所</span></a>
					</div>

					<div class=contents>
						<div class="departmenttitle">智慧农业研究所</div>
						<p style="font-size:20px;font-weight:bold;">智慧农业研究所    <img align="right"  src="Resources/css/contentimg/nongyes3.jpg" width="50px" height="50px"  /></p>
					    <br/>
						<p>智慧农业研究所致力于平行农业研究与产业化工作，专注于农业物联网、农业平行生产管理、农业标准化生产、计算植物等涉农方向的科技和产品研发，助力现代农业的发展。目前已研发农业物联网系统、智慧农业平行生产管理系统、农产品质量安全监管系统、智能花盆等系列软硬件产品。</p>
						<p style="font-size:20px;font-weight:bold;">研发团队</p>
						<p>智慧农业研究所负责人康孟珍博士，中国科学院自动化研究所副研究员，青岛智能产业技术研究院常务副院长，已建设一支具有物联网、自动化、农业、计算机等多学科融合特性的，具有多年涉农方向研发和管理工作经验的团队，是一支充满活力的，具有使命感的团队。</p>
						<p style="font-size:20px;font-weight:bold;">核心业务内容</p>
						<ul type="disc"
							style="font-family: 黑体;font-size: 16px;color: #202020;">
							<li>农业生产、流通、销售中的平行精细管理;</li>
							<li>融合农业物联网、大数据、云计算等智能技术的农业生产平行控制;</li>
							<li>农业生产安全、农产品质量安全监控与服务.</li>
						</ul>
						<p style="text-align:center;"><img src="Resources/css/contentimg/nongyes1.jpg" width="600px" height="320px"  /></p>
						<p style="text-align:center;"><img src="Resources/css/contentimg/nongyes2.jpg" width="600px" height="540px"  /></p>
