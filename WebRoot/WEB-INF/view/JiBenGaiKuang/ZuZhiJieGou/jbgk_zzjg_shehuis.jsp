...
<script type="text/javascript">
	$(function() {
	sessionStorage.focusUrl_Name = "jbgk_zzjg_shehuis.do";
								...
								<ul id="zzjgxiala" class="zzjgxiala">
									...
									<li id="jbgk_zzjg_shehuis"><a
										...
										style="color:#0956ac;"><img
											src="Resources/css/img/thirdnav.png" />&nbsp;智慧社会研究所</a></li>
				...
				<div class=rightcontent>
					<div class=contentnav>
						...
						<span class="glyphicon glyphicon-chevron-right"
							...
							style="color:#0066cc;"> 智慧社会研究所</span></a>
					</div>
					<div class=contents>
						<div class="departmenttitle">智慧社会研究所</div>
						<p style="font-size:20px;font-weight:bold;">智慧社会研究所</p>
						<p>智慧社会研究所及其孵化公司“青岛中科慧商智能科技有限公司”致力于研究开源情报大数据、商务智能和社会管理等及其领域的产业化工作。</p>
						<p style="font-size:20px;font-weight:bold;">研发团队</p>
						<p>智慧社会研究所所长袁勇，博士，中国科学院自动化研究所副研究员，2017年起开始担任青岛智能产业技术研究院副院长。现有员工20名，其中副研究员3名，助理研究员、工程师8名，研发的机器实习生小Q1名。团队累计完成高水平学术论文80余篇，获得专利4项，获得软著证书5项，学术专著1部；研发完成各类运营平台20余项并部分面向市场开放运营。</p>
						<p style="font-size:20px;font-weight:bold;">核心业务内容</p>
						<p>平行情报产品；社会管理产品；商务智能产品</p>
						<p style="text-align:center;"><img src="Resources/css/contentimg/shehuis1.png" width="600px" height="480px"  /></p>
						<br/>
						<p style="text-align:center;"><img src="Resources/css/contentimg/shehuis2.png" width="600px" height="384px"  /></p>
					</div>
