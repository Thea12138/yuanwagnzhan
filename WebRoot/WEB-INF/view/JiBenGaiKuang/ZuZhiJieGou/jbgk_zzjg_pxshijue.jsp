...
<script type="text/javascript">
	$(function() {
	sessionStorage.focusUrl_Name = "jbgk_zzjg_pxshijue.do";
									...
									<li><a
										href="javascript:ContentJump('jbgk_zzjg_pxshijue.do','jbgk_zzjg_pxshijue');"
										 style="color:#0956ac;letter-spacing:-1px;"><img
											src="Resources/css/img/thirdnav.png" />&nbsp;平行视觉技术创新中心</a></li>
								</ul>
							</li>
				...
				<div class=rightcontent>
					<div class=contentnav>
						...
						<span class="glyphicon glyphicon-chevron-right"
							...
							style="color:#0066cc;"> 平行视觉技术创新中心</span></a>
					</div>

					<div class=contents>
						<div class="departmenttitle">平行视觉技术创新中心</div>
						<p style="font-size:20px;font-weight:bold;">平行视觉技术创新中心</p>
						<p>平行视觉技术创新中心成立于2017年，致力于平行视觉基础理论及其在智能交通、智能车辆、影视媒体等领域的应用技术研究。平行视觉是ACP理论在视觉计算中的推广，是一种虚实互动的智能视觉计算方法。中心研究目标是在物理和网络空间大数据的驱动下，结合计算机图形学、虚拟现实、机器学习、知识自动化等技术，利用人工场景、计算实验、平行执行等理论和方法，建立复杂环境下视觉感知与理解的理论和方法体系。</p>
						<p style="font-size:20px;font-weight:bold;">研发团队</p>
						<p>中心成员10余名，包括1名副研究员、1名助理研究员和9名实习生。中心负责人王坤峰博士，现为中科院自动化所副研究员。苟超博士，现为中科院自动化所助理研究员。9名实习生都是中国科学院大学、中国科技大学、西安交通大学、北京理工大学等四所著名大学的在读研究生。</p>
						<p style="font-size:20px;font-weight:bold;">核心业务内容</p>
						<ul type="disc"
							style="font-family: 黑体;font-size: 16px;color: #202020;">
							<li>大规模多样性的人工场景和虚拟图像数据集</li>
							<li>视觉目标检测技术</li>
							<li>驾驶员脸部朝向和眼睛状态检测技术</li>
							<li>承担企业委托项目，攻关技术难题，在相关领域提供技术咨询</li>
						</ul>
						<p style="text-align:center;"><img src="Resources/css/contentimg/shijue1.jpg" width="600px" height="344px"  /></p>
					</div>
