...
<script type="text/javascript">
	$(function() {
	sessionStorage.focusUrl_Name = "jbgk_zzjg_jiaoyus.do";
								...
								<ul id="zzjgxiala" class="zzjgxiala">
									...
									<li id="jbgk_zzjg_jiaoyus"><a
										...
										style="color:#0956ac;"><img
											src="Resources/css/img/thirdnav.png" />&nbsp;智慧教育研究所</a></li>
				...
				<div class=rightcontent>
					<div class=contentnav>
						...
						<span class="glyphicon glyphicon-chevron-right"
							...
							style="color:#0066cc;"> 智慧教育研究所</span></a>
					</div>

					<div class=contents>
						<div class="departmenttitle">智慧教育研究所</div>
						<p style="font-size:20px;font-weight:bold;">智慧教育研究所 <img src="Resources/css/contentimg/jiaoyus2.jpg" width="50px" height="50px"  align="right"/></p>
						<br/>
						<p>智慧教育研究所致力于开展教育领域智能技术研究与产业化工作，研究平行系统、大数据、物联网等技术与教育的深度融合，助力教育综合改革和课程改革落地实施。</p>
						<p style="font-size:20px;font-weight:bold;">研发团队</p>
						<p>智慧教育研究所拥有专业的课程开发人员、教育培训讲师、教育装备研发工程师和平行智慧教育研究人才，其中具有博士学位和高级职称的人员4人，有硕士学位的人员8人。</p>
						<p style="font-size:20px;font-weight:bold;">核心业务内容</p>
						<ul type="disc"
							style="font-family: 黑体;font-size: 16px;color: #202020;">
							<li>面向智能时代的中小学科技创新教育</li>
							<li>平行自适应智慧教育技术</li>
							<li>产学研协同的智能产业技术教育培训</li>
						</ul>
						<p style="text-align:center;"><img src="Resources/css/contentimg/jiaoyus1.jpg" width="600px" height="341px"  /></p>
