...
<script type="text/javascript">
	...
	$(function() {
	if(sessionStorage.focusUrl_Name=="cpfa_nongyes_frame.do" ){
		if(sessionStorage.pageno!=undefined && sessionStorage.pageno!='')	{
		    pageno=sessionStorage.pageno;
		}
		
	 }
	sessionStorage.focusUrl_Name = "cpfa_nongyes_frame.do";
			...
			<div class=contentshow>
				...
				<div class=rightcontent>
					<div class=contentnav>
						...
						<a href="javascript:void(0);"><span style="color:#0066cc;">智慧农业研究所</span></a>
					</div>
