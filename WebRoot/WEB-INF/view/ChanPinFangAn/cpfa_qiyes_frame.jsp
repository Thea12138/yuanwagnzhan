...
<script type="text/javascript">
	...
	$(function() {
	if(sessionStorage.focusUrl_Name=="cpfa_qiyes_frame.do" ){
		if(sessionStorage.pageno!=undefined && sessionStorage.pageno!='')	{
		    pageno=sessionStorage.pageno;
		}
		
	 }
	sessionStorage.focusUrl_Name = "cpfa_qiyes_frame.do";
			...
			<div class=contentshow>
					...
					<div class=secondnav>
						<ul>
							...
							<li><img src="Resources/css/img/juset.jpg" /><a
								href="javascript:ContentJump('cpfa_qiyes_frame.do');"><span
									class="glyphicon glyphicon-chevron-right"
				...
				<div class=rightcontent>
					<div class=contentnav>
						...
						<a href="javascript:void(0);"><span style="color:#0066cc;">智慧企业研究所</span></a>
					</div>
