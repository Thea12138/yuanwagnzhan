...
<script type="text/javascript">
	...
	$(function() {
	if(sessionStorage.focusUrl_Name=="kyhd_zdxm_frame.do" ){
		if(sessionStorage.pageno!=undefined && sessionStorage.pageno!='')	{
		    pageno=sessionStorage.pageno;
		}
		
	 }
	sessionStorage.focusUrl_Name = "kyhd_zdxm_frame.do";
						...
						function(data) {
							...
							if (data != null) {
								...
								for (var i = 0; i < list.length; i++) {
									ht = ht
											+ "<tr>"
											+ "<td  style='width:690px;'><a href='javascript:ContentJumpPage(\"ProjectShow.do?ProjectID="
											+ list[i].ProjectID
											+ "\");'>"
											+ SubStrFun(list[i].ProjectTitle,
													50)
											+ "</a></td>"
											+ "<td style='width:80px;'>"
											+ (list[i].PublicDate == null ? ""
													: ("["
															+ (ymdDate(
																	list[i].PublicDate,
																	'yyyy-MM-dd')) + "]"))
				...
				<div class=leftnav>
					...
					<div class=secondnav>
						<ul>
							...
							<li id="kyhdzdxmframe"><img
								src="Resources/css/img/juset.jpg" /><a
