...
//            }, 100);
    ...
    $.fn.fileinput.defaults = {
        ...
        maxFileSize: 0,
        maxFileCount: 0,
        msgSizeTooLarge: 'File "{name}" (<b>{size} KB</b>) 超过最大允许上传大小 <b>{maxSize} KB</b>. 请重试您上传的文件!',
        msgFilesTooMany: '选择上传文件数 <b>({n})</b> 超过允许的最大限制 <b>{m}</b>. 请重试您上传的文件!',
        msgFileNotFound: '文件 "{name}" 没有找到!',
        msgFileNotReadable: '文件 "{name}" 不可读.',
        msgFilePreviewAborted: '预览失败 "{name}".',
        msgFilePreviewError: '在读取文件时发生了一个错误 "{name}".',
        msgInvalidFileType: '无效的类型 "{name}". 只支持 "{types}" 格式的文件.',
        msgInvalidFileExtension: '无效的类型 "{name}". 只支持 "{extensions}" 格式的文件.',
